...
var EffectUtil = (function () {
    ...
    function EffectUtil() {
        EffectUtil.__super.call(this);
    }

    Laya.class(EffectUtil, "src.util.EffectUtil", BaseClass);
    var _proto_ = EffectUtil.prototype;
     ...
     */
    _proto_.iconShake = function(obj, initY, callback, thisObj) {
        //抖动频率[时间，移动距离]，可修改
        var arr = [
            [20, 300],
            [15, 300],
